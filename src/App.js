...
// Updated character CSS styles with fixed positioning for all characters
      ...
      case 'start':
        return (
          <>
            ...
            {/* The giraffe image - now moved outside the main content container */}
            <img 
      ...
      case 'playing':
        return (
          <>
            ...
            {/* The robot image - kept outside the main content container */}
            <img 
              src={characters.robot} 
              alt="AI Robot" 
      ...
      case 'result':
        ...
        return (
          <>
            ...
            {/* The giraffe image - kept outside the main content container */}
            <img 
              src={characters.giraffe} 
              alt="Skateboarding Giraffe" 
              style={characterStyles.giraffeBottom}
      ...
      case 'instructions':
        return (
          <>
            ...
            {/* Using Charlie character instead of giraffe for this screen */}
            <img 
              src={characters.charlie} 
              alt="Charlie" 
